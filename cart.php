...
if (isset($_GET["action"])) {
    if ($_GET["action"] == "delete") {
        foreach ($_SESSION["cart"] as $keys => $value) {
            ...
            $query = mysqli_query($koneksi, "SELECT * FROM pembeli WHERE email='$_SESSION[email]'");
            $d = mysqli_fetch_array($query);
            $id_pembeli = $d['id_pembeli'];
            $alamat = $_POST['alamat'];
            $sql = mysqli_query($koneksi, "INSERT INTO membeli(total,tgl_transaksi,id_pembeli,alamat) value ('$total','".date("Y-m-d")."','$id_pembeli','$alamat')");
            }
